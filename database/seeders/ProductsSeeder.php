...
class ProductsSeeder extends Seeder
{
    ...
    private function seedProducts()
    {
        return $cat = array(
            ...
            'ID Screen® Infectious Bronchitis Competition', 'price' => 2000, 'product_slug' => 'IIB', 'code' => 'VDEA01', 'description' => 'https://www.id-vet.com/produit/id-screen-infectious-bronchitis-competition/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 10),
            array('nested_sub_category_id' => 1, 'product_disease_id' => '1', 'product_name' =>
            'ID Screen® Infectious Bronchitis Indirect', 'price' => 1500, 'product_slug' => 'IBI', 'code' => 'VDEA02', 'description' => 'https://www.id-vet.com/produit/id-screen-infectious-bronchitis-indirect/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 10),
            array('nested_sub_category_id' => 1, 'product_disease_id' => '2', 'product_name' =>
            'ID Screen® ILT gB Indirect', 'price' => 1800, 'product_slug' => 'ILTGBI', 'code' => 'VDEA03', 'description' => 'https://www.id-vet.com/produit/id-screen-ilt-gb-indirect/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 5),
            array('nested_sub_category_id' => 1, 'product_disease_id' => '2', 'product_name' =>
            'ID Screen® ILT gI Indirect', 'price' => 2800, 'product_slug' => 'ILTGII', 'code' => 'VDEA04', 'description' => 'https://www.id-vet.com/produit/id-screen-ilt-gi-indirect/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 2),
            array('nested_sub_category_id' => 1, 'product_disease_id' => '2', 'product_name' =>
            'ID Screen® ILT Indirect', 'price' => 8000, 'product_slug' => 'ILTI', 'code' => 'VDEA05', 'description' => 'https://www.id-vet.com/produit/id-screen-ilt-indirect/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 5),
            array('nested_sub_category_id' => 1, 'product_disease_id' => '3', 'product_name' =>
            'ID Screen® Newcastle Disease Competition', 'price' => 4500, 'product_slug' => 'NDC', 'code' => 'VDEA06', 'description' => 'https://www.id-vet.com/produit/id-screen-newcastle-disease-competition/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 5),
            array('nested_sub_category_id' => 1, 'product_disease_id' => '3', 'product_name' =>
            'ID Screen® Newcastle Disease Indirect', 'price' => 1450, 'product_slug' => 'NDI', 'code' => 'VDEA07', 'description' => 'https://www.id-vet.com/produit/id-screen-newcastle-disease-indirect/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 10),
            array('nested_sub_category_id' => 1, 'product_disease_id' => '3', 'product_name' =>
            'ID Screen® Newcastle Disease Indirect Conventional Vaccines', 'price' => 1950, 'product_slug' => 'NDICV', 'code' => 'VDEA08', 'description' => 'https://www.id-vet.com/produit/id-screen-newcastle-disease-indirect-conventional-vaccines/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 20),
            array('nested_sub_category_id' => 1, 'product_disease_id' => '3', 'product_name' =>
            'ID Screen® Newcastle Disease Nucleoprotein Indirect', 'price' => 1235, 'product_slug' => 'NDNI', 'code' => 'VDEA09', 'description' => 'https://www.id-vet.com/produit/id-screen-newcastle-disease-nucleoprotein-indirect/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 20),
            array('nested_sub_category_id' => 1, 'product_disease_id' => '4', 'product_name' =>
            'ID Screen® Avian Reovirus Indirect', 'price' => 1000, 'product_slug' => 'ARI', 'code' => 'VDEA09', 'description' => 'https://www.id-vet.com/produit/id-screen-avian-reovirus-indirect/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 20)
