...
class ProductsSeeder extends Seeder
{
    ...
    private function seedProducts()
    {
        return $cat = array(
            ...
            'ID Screen® Infectious Bronchitis Competition', 'price' => 20, 'product_slug' => 'IIB', 'code' => 'VDEA01', 'description' => 'https://www.id-vet.com/produit/id-screen-infectious-bronchitis-competition/', 'is_variant' => 'no', 'status' => 'active', 'discount' => 10),
            array('nested_sub_category_id' => '1', 'product_disease_id' => '1', 'product_name' =>
